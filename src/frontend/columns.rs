...
impl From<TuiColumn> for Column {
    fn from(value: TuiColumn) -> Self {
        match value {
            ...
            TuiColumn::Jitter => Self::new(ColumnType::Jitter),
            TuiColumn::Javg => Self::new(ColumnType::Javg),
            TuiColumn::Jmax => Self::new(ColumnType::Jmax),
            TuiColumn::Jinta => Self::new(ColumnType::Jinta),
            TuiColumn::LastSrcPort => Self::new(ColumnType::LastSrcPort),
            TuiColumn::LastDestPort => Self::new(ColumnType::LastDestPort),
            TuiColumn::LastSeq => Self::new(ColumnType::LastSeq),
        }
    }
}
