...
///
/// The `Tracer` struct is the core of the tracing functionality, providing methods to run traceroute operations.
/// It encapsulates the tracing logic, allowing users to perform network tracing with various configurations.
///
/// # Examples
///
/// Basic usage:
...
/// use std::str::FromStr;
///
/// let target_addr = IpAddr::from_str("1.1.1.1").unwrap();
